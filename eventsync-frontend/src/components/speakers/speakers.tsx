...
export default function SpeakersPage() {
  ...
  return (
    <div className="relative min-h-screen">
      <div className="fixed top-10 left-0 w-96 h-96 bg-lime-400/5 blur-[140px] pointer-events-none" />
      <div className="fixed bottom-0 right-0 w-96 h-96 bg-sky-400/5 blur-[140px] pointer-events-none" />
